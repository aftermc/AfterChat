...
public class UpdatePlugin {
    ...
    public void getVersion(final Consumer<String> consumer) {
        Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
            try (InputStream inputStream = new URL("https://raw.githubusercontent.com/aftermc/AfterChat/master/version.txt").openStream(); Scanner scanner = new Scanner(inputStream)) {
